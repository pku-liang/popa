...
protected:
    ...
    protected:
        ...
        public:
            ...
            DefineVectorStructTypes(CodeGen_OneAPI_C *parent)
                : parent(parent) {
            }
        ...
        public:
            std::string channels;
            DeclareChannels(CodeGen_OneAPI_C *parent)
                : parent(parent) {
            }
        ...
        public:
            ...
            DeclareArrays(CodeGen_OneAPI_C *parent)
                : parent(parent) {
            }
        ...
        public:
            ...
            CheckConditionalChannelAccess(CodeGen_OneAPI_C *parent, std::string current_loop_name)
        ...
        void visit_binop(Type t, const Expr &a, const Expr &b, const char *op) override;
