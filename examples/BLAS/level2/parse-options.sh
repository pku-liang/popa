...
function show_usage {
   echo "Options: (devcloud|local) (gemv|gbmv|ger|gerc|geru|hemv|hbmv|her|her2|symv|sbmv|syr|syr2|trmv|tbmv|trsv|tbsv) (a10|s10|gen9|gen12) (tiny|large) (hw|emulator) [bitstream]"
}
...
if [[ ! "$2" =~ ^(gemv|gbmv|ger|gerc|geru|hemv|hbmv|her|her2|symv|sbmv|syr|syr2|trmv|tbmv|trsv|tbsv)$ ]]; then
    show_usage
    return
else
    workload="$2"
