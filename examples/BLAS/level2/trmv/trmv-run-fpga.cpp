...
int main()
{
    ...
    float number_ops = 2 * (float)(III * II * I) * (float)(KK * K); // Total operations (GFLOP for GEMV), independent of designs
    float number_bytes = (float)(III) * (float)(KK * II) * (float)(K * I) * 4 +
                         (float)(KK * K) * 4 +
                         (float)(III * II * I) * 4;
