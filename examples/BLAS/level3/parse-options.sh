...
function show_usage {
   echo "Options: (devcloud|local) (gemm|hemm|her2k|herk|syr2k|syrk|trmm|trsm) (a10|s10|gen9|gen12) (tiny|large) (hw|emulator) [bitstream]"
}
...
if [[ ! "$2" =~ ^(gemm|hemm|her2k|herk|syr2k|syrk|trmm|trsm)$ ]]; then
    show_usage
    return
else
    workload="$2"
