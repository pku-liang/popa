...
int main()
{
         ...
         for (int jj = 0; jj < JJ; jj++)
            for (int iii = 0; iii < III; iii++)
             for (int jjj = 0; jjj < JJJ; jjj++) {
                ...
                if (j < i) {
                    assert(fabs(golden - c(iii, jjj, ii, jj, i, j)) < 0.005*fabs(golden));
                } else {
    ...
    double number_ops = 4 * (double)(III * II * I) * (double)(JJJ * JJ * J) * (double)(KKK * KK * K); // Total operations (GFLOP for GEMM), independent of designs
